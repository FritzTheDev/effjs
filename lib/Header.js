        ...
        >
          <div className="text-sm lg:flex-grow">
            ...
            <Link href="/hire-me" passHref>
              <a
                className="block mt-4 lg:inline-block lg:mt-0 text-orange-200 text-base font-display hover:text-white"
              >
                Hire Fritz
              </a>
            </Link>
          ...
          <div>
            ...
            <a
              className="inline-block text-sm px-4 py-4 leading-none border rounded text-white border-white hover:border-transparent hover:text-orange-600 hover:bg-white mt-4 lg:mt-0"
            >
