...
export const IndexPost = ({ imgSrc, postHref, title, subtitle, date }) => (
  <Link href={postHref}>
    <span className="w-full my-4 md:w-1/2 lg:w-1/3">
      <article className="flex md:flex-col min-h-full cursor-pointer bg-gray-400 hover:bg-orange-500 mx-2 p-4 justify-end">
        <img
          className="rounded-lg w-32 md:w-auto h-auto mx-auto"
          src={imgSrc}
        />
        <div className=" my-auto mx-5 md:mx-auto flex flex-col h-full">
